...
long int normal_x,normal_y,normal_z, deltha_x[3],deltha_y[3],deltha_z[3], deltha, angle_1[3], angle_2[3] ; // 노말라이즈(정규화 데이터), 가속도 변화량 표시
...
//기울기값
long int angle_init = 9999;
long int minus_angle=0;
...
void loop()
{
  ...
  if((minus_angle < 50)&&(deltha > Emergency_value2)&&(shock_value < Emergency_shock)){State_Parameter=true;}  
